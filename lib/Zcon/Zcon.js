...
var _iconfontEs = require("../../assets/iconfont/iconfont-es");

var _iconfontEs2 = _interopRequireDefault(_iconfontEs);
  ...
  var Zcon = function (_Component) {
    ...
    function Zcon() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Zcon.__proto__ || Object.getPrototypeOf(Zcon)).call.apply(_ref, [this].concat(args))), _this), _this.getType = function () {
        ...
        if (p === PREFIX && _iconfontEs.specialViewBox[type]) {
          return _iconfontEs.specialViewBox[type];
        }
    ...
    _createClass(Zcon, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            otherProps = _objectWithoutProperties(_props, ["spin", "svg", "style", "className", "antCls", "prefix", "viewBox"]);
        ...
        var hasCache = p === PREFIX && _iconfontEs2.default[type];
        if (hasCache) {
          children = _iconfontEs2.default[type].map(function (props, index) {
